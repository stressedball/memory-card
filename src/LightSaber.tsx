  ...
  return (
    <>
      <svg
        ...
        version="1.1"
        id="Capa_1"
        viewBox="0 0 498.254 498.254"
        xmlSpace="preserve"
      >
        <g>
          <path
            d="M487.57,10.684c-12.299-12.299-33.335-16.162-49.749,0.251L231.313,217.443c-1.519-1.519-3.496-2.538-5.672-2.843
          ...
          />
          <path
            d="M142.229,363.096l-7.071-7.071c-3.904-3.903-10.236-3.904-14.142,0c-3.905,3.905-3.906,10.236,0,14.143l7.071,7.071
          c1.953,1.952,4.512,2.929,7.071,2.929c2.559,0,5.118-0.977,7.071-2.929C146.134,373.333,146.135,367.002,142.229,363.096z"
          />
          <path
            d="M113.945,377.237c-3.905-3.904-10.237-3.904-14.143,0c-3.905,3.905-3.905,10.237,0,14.143l7.071,7.071
